    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="mb-6">
            <h1 className="text-2xl font-bold mb-2">{t('Dashboard.history.title')}</h1>
            <p className="text-muted-foreground">{t('Dashboard.history.description')}</p>
          </div>
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center gap-2 mt-8">
                  ...
                  <span className="text-sm text-muted-foreground px-4">
                    {t('History.pagination.pageInfo').replace('{current}', page.toString()).replace('{total}', totalPages.toString())}
                  </span>
                  <Button
                    variant="outline"
                    size="sm"
